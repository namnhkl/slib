...
import { IChuyenDeResponse } from '../stsBoSuuTapDs-chuyen-de.type';
...
@Component({
  ...
  templateUrl: './stsBoSuuTapDs-chuyen-de-item.component.html',
  styleUrls: ['./stsBoSuuTapDs-chuyen-de-item.component.scss'],
  providers: [stsBoSuuTapDsChuyenDeService],
})
export class stsBoSuuTapDsChuyenDeItemComponent implements OnInit {
  constructor(
